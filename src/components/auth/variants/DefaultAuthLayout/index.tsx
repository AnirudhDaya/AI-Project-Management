...
function Default(props: { maincard: JSX.Element }) {
  ...
  return (
    <div className="relative flex">
      ...
      <div  className="mx-auto  flex min-h-full w-full flex-col justify-start pt-12 md:max-w-[75%] lg:max-w-[1013px] lg:px-8 lg:pt-0 xl:h-[100vh] xl:max-w-[1383px] xl:px-0 xl:pl-[70px]  lg:pt-0 xl:pl-[70px] overflow-y-auto">
          ...
          <div className="absolute right-0 hidden h-full min-h-screen md:block lg:w-[49vw] 2xl:w-[44vw]">
            ...
            >
              <div className="relative flex h-full w-full">
                <div
                  style={{ backgroundImage: `url(${authImg.src})` }} //horizon logo
